...
const roles = [
  ...
  },
  {
    ...
    body: 'Secure REST API and Webhook delivery of every sale, subscription, and lead event. Full visibility into campaign ROI without logging into your BPO\'s system.',
    bullets: [
